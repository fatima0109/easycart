                            ...
                            <div className="row justify-content-center"> 
                                <div className="col-lg-8 text-center"> 
                                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                                        <span className="badge bg-black px-3 py-2 rounded-pill text-uppercase tracking-widest fw-bold mb-3" style={{ fontSize: '10px' }}>
                                            New Season Arrival
                                        </span>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-10 bg-[#1F2A44] rounded-4 p-5 text-center text-white shadow-2xl overflow-hidden position-relative">
                                    ...
                                    <div className="position-relative z-1">
                                        <h2 className="display-5 fw-bold text-black mb-3">Upgrade Your Lifestyle</h2>
                                        <p className="text-black mb-5 h5 fw-normal">Join 50,000+ shoppers who trust EasyCart for premium quality gear.</p>
