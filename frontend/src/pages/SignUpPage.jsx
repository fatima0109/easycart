            ...
            <AnimatePresence mode="wait">
              {!isVerifying ? (
                ...
                <motion.form key="signup" onSubmit={handleSubmit} className="space-y-4" exit={{ opacity: 0, x: -20 }}>
                  ...
                  {/* RESTORED ORIGINAL FULL-WIDTH BUTTON */}
                  <button
                    type="submit"
                ...
                <motion.form key="otp" onSubmit={handleVerify} className="space-y-6" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative text-center">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-30">
                        <KeyRound className="h-5 w-5 text-[#C97C5D]" />
                      </div>
                      <input 
                        type="text" 
                        maxLength="6"
                  ...
                  <button 
                    type="submit" 
                    className="btn btn-primary w-full flex justify-center items-center gap-2 py-3 px-4 border-0 rounded-lg shadow-md text-sm font-bold text-white bg-[#1F2A44] hover:opacity-90 transition-all disabled:opacity-50"
                    disabled={loading}
                  >
