...
import User from "../models/user.model.js"; // 1. Added User model import
...
export const checkoutSuccess = async (req, res) => {
	try {
		...
		if (session.payment_status === "paid") {
			...
			// 2. Create new Order with explicit status
			...
			const newOrder = new Order({
				...
				totalAmount: session.amount_total / 100, // conversion from cents to dollars
				stripeSessionId: sessionId,
				status: "processing", // Matches the default in our new model schema
			});
